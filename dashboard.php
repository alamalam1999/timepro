	    ...
	    <div>
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-9 col-lg-6 col-xl-8">
                        ...
                        <button onclick="location.href='https://sekolah-avicenna.sch.id/tiketgsuite/'" class="btn btn-lg btn-block btn-primary mb-2" style="font-size:13px; background-color: #15bee8;"
                                            type="submit"><strong> MASUK PELAYANAN G-SUITE SEKOLAH AVICENNA </strong> </button>
                    </div>
                </div>
            </div>
		<fieldset>
			...
			<legend><h1 style = "font-weight: 900;">Ticketing Helpdesk</h1></legend>
