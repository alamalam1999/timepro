      ...
      <section id="content">
        ...
        <div class="container">
          ...
          if (isset($_POST['insert'])) {
            ...
            $sendmail->setFrom('adialamalam@gmail.com', 'TimePRO Tiket'); //email pengirim
            $sendmail->addReplyTo('adialamalam@gmail.com', 'Hakko Bio Richard'); //email replay
            $sendmail->addAddress("$email", "$nama"); //email tujuan
            //$sendmail->AddBCC("$email");
            $sendmail->Subject = "Tiket TimePro $id_tiket"; //subjek email
