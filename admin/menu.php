<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
        ...
        <li class="no-padding">
            ...
            <ul class="collapsible collapsible-accordion">
                <li class="bold"><a href="input_calendar_project.php" class="collapsible-header waves-effect waves-cyan"><i class="mdi-communication-email"></i> Kalender Kerja <span class="new badge count"></span></a>
