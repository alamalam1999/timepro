        ...
        <div class="container">
          ...
          if (isset($_POST['update'])) {
            ...
            if ($firstname != '' && $password != '' && $email_sekolah != '') {
              ...
              $laporan .= "</tr>";
              $laporan .= "<tr>";
              $laporan .= "<td>No Handphone</td><td>:</td><td>$nama_pekerjaan</td>";
              $laporan .= "</tr>";
              $laporan .= "<tr>";
              ...
              <div class="row">
                <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" class="col s12">
                  ...
                  <div class="row">
                    <div class="input-field col s12">
                      <!-- <i class="mdi-communication-email prefix"></i> -->
                      <input id="email" name="nama_pekerjaan" value="<?php echo $row['nama_pekerjaan']; ?>" type="email" readonly="readonly">
